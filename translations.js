// Fundación Rimas - Bilingual Translations (Spanish & English)
...
const translations = {
    es: {
        ...
        hero: {
            ...
            subtitle: "Transformando vidas a través del acompañamiento continuo",
            stat1: "Jóvenes Impactados",
            stat2: "Campus Activos",
            stat3: "% Tasa de Retención",
            stat4: "+ Horas de Programación"
        },
        // Diferenciador Section
        diferenciador: {
            mainTitle: "Más que eventos, creamos sistemas de cambio",
            pilar1Title: "Continuidad",
            pilar1Text: "Programas durante todo el año, no eventos aislados",
            pilar2Title: "Acompañamiento",
        ...
        historia: {
            ...
            name: "Juan Fox",
            quote: '"De Caras con Causa a la UPR estudiando música popular"',
            description: "Juan es el primer becado de nuestra residencia, representando un hito en nuestro compromiso con el desarrollo integral de los jóvenes. Su trayectoria desde Caras con Causa hasta la Universidad de Puerto Rico demuestra el poder del acompañamiento continuo y el apoyo estructurado.",
            timeline1Year: "2023 - Caras con Causa",
            timeline1Text: "Inicia su camino con Fundación Rimas",
            timeline2Year: "2024 - Beca Residencial",
            timeline2Text: "Primer becado del programa",
            timeline3Year: "2025 - UPR",
            timeline3Text: "Estudiando Música Popular",
            ctaButton: "Conoce más historias"
        },
        // Academia Section
        academia: {
            title: "La Academia en Acción",
            subtitle: "Proyectos reales, habilidades transferibles, impacto medible",
            villalba: "Villalba",
            villaalbaMission: "Produciendo un Álbum",
            villalbaParticipants: "79 participantes",
            villalbaDesc: "Creando música desde el sistema correccional, transformando vidas a través del arte y la expresión.",
            villalbaHighlight: "Destacado: Bootcamp con Xander Zayas sobre disciplina y superación",
            skillsLabel: "Destrezas desarrolladas:",
            composicion: "Composición",
            trabajoEquipo: "Trabajo en equipo",
            expresionCreativa: "Expresión creativa",

            carasConCausa: "Caras con Causa",
            carasMission: "Organizando su Evento",
            carasParticipants: "15 jóvenes",
            carasDesc: "Planificando su Welcome Back Party con autonomía total en la gestión del proyecto.",
            carasHighlight: "Comités: Fundraising, logística, promoción",
            ...
            llorensParticipants: "15 jóvenes",
            llorensDesc: "Creando un cortometraje sobre crecer en Llorens Torres, utilizando tecnología e IA en entretenimiento.",
            llorensHighlight: "Proyecto: Cortometraje comunitario con tecnología de punta",
            narrativaVisual: "Narrativa visual",
            tecnologia: "Tecnología",
            identidadCultural: "Identidad cultural",

            inesMaria: "Inés María Mendoza",
            inesMission: "Pitch Final",
            inesParticipants: "21 jóvenes",
            inesDesc: "Presentación ante panel evaluador sobre planificación de eventos de entretenimiento.",
            inesHighlight: "Colaboración: ConPRmetidos y programa Futuro ConPR",
            presentacionEjecutiva: "Presentación ejecutiva",
            planificacionEstrategica: "Planificación estratégica"
        },
        // Destrezas Section
        destrezas: {
        ...
        alianzas: {
            ...
            subtitle: "Juntos logramos más",
            wendys: "Wendy's",
            wendysDesc: 'Campaña "El Talento de Aquí es Otra Cosa" - Recaudando fondos para becas universitarias 2026 en música, arte y deportes.',
            eladio: "Eladio Carrión",
            eladioDesc: "Programa Therapy Dogs y apoyo continuo a nuestros jóvenes participantes.",
            ...
            dcr: "DCR",
            dcrDesc: "Departamento de Corrección y Rehabilitación - Transformando el sistema desde adentro.",
            ...
            partner5: "Fundación Felisa Rincón de Gautier",
        ...
        footer: {
            ...
            copyright: "© 2025 Fundación Rimas. Todos los derechos reservados. | 501(c)(3) Nonprofit Organization | Established 2018"
        },
        // Buttons & UI
        ui: {
            ...
            easterEgg: "🎉 ¡Código secreto activado! Gracias por apoyar a los jóvenes de PR"
        }
    },
    en: {
        // Navigation
        ...
        historia: {
            ...
            timeline1Year: "2023 - Caras con Causa",
            timeline1Text: "Begins his journey with Fundación Rimas",
        ...
        footer: {
            ...
            subscribe: "Subscribe",
            copyright: "© 2025 Fundación Rimas. All rights reserved. | 501(c)(3) Nonprofit Organization | Established 2018"
        },
        // Buttons & UI
        ui: {
    ...
    updatePageMeta() {
        ...
        if (lang === 'en') {
            ...
            document.querySelector('meta[property="og:title"]').content =
                'Fundación Rimas - Transforming Youth PR';
            document.querySelector('meta[property="og:description"]').content =
                'Unique organization working with youth in juvenile justice in PR. More than events, we create systems of change.';
            document.title = 'Fundación Rimas - Transforming Youth PR | Newsletter October 2025';
        } else {
            document.querySelector('meta[name="description"]').content =
                'Únicos trabajando con jóvenes en justicia juvenil en PR. 123 jóvenes impactados, 6 campus activos. Más que eventos, creamos sistemas de cambio.';
            document.querySelector('meta[property="og:title"]').content =
                'Fundación Rimas - Transformando Juventud PR';
            document.querySelector('meta[property="og:description"]').content =
                'Únicos trabajando con jóvenes en justicia juvenil en PR. Más que eventos, creamos sistemas de cambio.';
            document.title = 'Fundación Rimas - Transformando Juventud PR | Boletín Octubre 2025';
        }
    },
...
// Debug information
console.log('Fundación Rimas - Language Switcher loaded');
